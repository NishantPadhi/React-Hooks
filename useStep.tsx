 ...
 * 
    ...
    The hook should provide utility methods to go to the next and previous steps, and
    allow resetting of the step counter. The step number is 1-indexed and goes up at most to maxStep.
 */
